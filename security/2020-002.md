...
or, if you have installed Sympa using earlier version of source distribution,
   ...
   - Apply a patch to the source, recompile wrappers and reinstall them:
     ...
     Patch for sympa-6.2 or later: [sympa-6.2.54-sa-2020-002-r2.patch](https://github.com/sympa-community/sympa/releases/download/6.2.56/sympa-6.2.54-sa-2020-002.patch)
